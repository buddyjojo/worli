...
winrewim=$(find /tmp/worli/winpart/Windows/System32/Recovery/ -type f -name [Ww]inre.wim)

wimupdate $winrewim 1 --command="add ${pei} /worlipe.cmd"

wimupdate $winrewim 1 --command="rename /sources/recovery/RecEnv.exe /sources/recovery/RecEnv.exe.bak"
...
wimupdate $winrewim 1 --command="add /tmp/worli/driverpackage /drivers"
